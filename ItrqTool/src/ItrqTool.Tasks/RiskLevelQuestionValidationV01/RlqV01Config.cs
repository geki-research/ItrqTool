...
// RLQ_v01 config. Sheet name + the 12 column letters + SectionRows, mirroring the shape /
// strictness of the CLQ v01/v02 config classes (init properties defaulting to ""/[], a
// Validate() returning the list of errors). Differences from CLQ:
//   - sections-only: NO ChapterRows;
//   - NO AllowedAnswers / DeviationThreshold (deferred to a later chunk);
...
public sealed class RlqV01Config
{
