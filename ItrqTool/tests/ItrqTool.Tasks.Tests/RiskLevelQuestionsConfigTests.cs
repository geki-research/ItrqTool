...
public sealed class RiskLevelQuestionsConfigTests
{
    [Fact]
    public void ParsedSections_EmptySectionRows_ReturnsEmptyList()
    {
        var cfg = new RiskLevelQuestionsConfig();
    ...
    {
        var cfg = new RiskLevelQuestionsConfig { SectionRows = [entry] };
    ...
    {
        var cfg = new RiskLevelQuestionsConfig { SectionRows = ["2:5-4"] };
        var act = () => cfg.ParsedSections;
        act.Should().Throw<FormatException>().WithMessage("*lastQuestionRow*");
    }
    ...
    {
        var cfg = new RiskLevelQuestionsConfig { SectionRows = ["3:4-4"] };
        var sections = cfg.ParsedSections;
