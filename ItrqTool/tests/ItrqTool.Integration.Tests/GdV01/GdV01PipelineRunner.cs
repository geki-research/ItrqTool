...
public static class GdV01PipelineRunner
{
        ...
        string previousPath)
    {
        ...
        // Wrap patched lists back into GdV01ParseResult (preserving Malformed from parse).
        var patchedCurrent  = new GdV01ParseResult(patchedCurrentQs,  cur.Malformed);
        var patchedTemplate = new GdV01ParseResult(patchedTemplateQs, tmp.Malformed);
        var patchedPrevious = new GdV01ParseResult(patchedPreviousQs, prv.Malformed);
